...
namespace MVCOnlineTicariOtomasyonn.Controllers
{
    public class İstatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.d8 = deger8;
            var deger9 = (from x in c.Ürüns orderby x.SatisFiyat ascending select x.UrunAd).FirstOrDefault();
            ViewBag.d9 = deger9;
            var deger10 = c.Ürüns.Count(x => x.UrunAd == "Buzdolabı").ToString();
            ViewBag.d10 = deger10;
            var deger11 = c.Ürüns.Count(x => x.UrunAd == "Laptop").ToString();
            ViewBag.d11 = deger11;
            var deger12 = c.Ürüns.GroupBy(x => x.Marka).OrderByDescending(z => z.Count()).Select(y => y.Key).FirstOrDefault();
            ViewBag.d12= deger12;
            var deger13 =c.Ürüns.Where(u=>u.UrunID == (c.SatisHarekets.GroupBy(x => x.UrunId).OrderByDescending(z => z.Count()).Select(y => y.Key).FirstOrDefault())).Select(k=>k.UrunAd).FirstOrDefault();
            ViewBag.d13= deger13;
            ...
            ViewBag.d15 = deger15;
            var deger16 = c.SatisHarekets.Where(x => x.Tarih == bugün).Sum(x => x.ToplamTutar).ToString();
            ViewBag.d16 = deger16;
            return View();
        }
    }
